...
.SYNOPSIS
    ...
    Runs Phases 1–4 in sequence with dependency checks.
...
.DESCRIPTION
    ...
    Run this script after:
        ...
        2. BadSQL.ps1               (SQL Server + NailInventoryDB)
...
.PARAMETER Force
    Pass -Force to Phase 2/3 to recreate resources even if they already exist.
...
.EXAMPLE
    ...
    .\Invoke-ContinuousActivitySimulator.ps1 -SkipPhase1 -SkipPhase2
...
Write-Log "" "INFO"
Write-Log "Pending phases:" "INFO"
Write-Log "  [ ] Phase 5 — Customer Orders (IIS Web Requests)" "INFO"
Write-Log "  [ ] Phase 6 — Realistic Email & Communications (SMTP)" "INFO"
Write-Log "" "INFO"
...
Write-Log "  Invoke-LockoutSimulator.ps1      (Phase 3)" "INFO"
Write-Log "  Invoke-HelpdeskAutoResolve.ps1   (Phase 3)" "INFO"
Write-Log "  Invoke-UserSessionSimulator.ps1  (Phase 4)" "INFO"
